...
DECLARE
  ...
  tables text[] := ARRAY[
    ...
    'client_billing_notes', 'client_authorization_templates',
    'client_clinical_assessments', 'client_clinical_assessment_artifacts',
    'client_clinical_assessment_details',
    'notification_preferences', 'task_notification_logs',
