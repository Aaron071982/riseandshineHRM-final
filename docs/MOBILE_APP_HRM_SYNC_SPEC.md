...
Before implementing, get these from the HRM team or environment:
...
If any of these are missing in the app’s environment, the app does not send a sync request (clock out still succeeds locally).
