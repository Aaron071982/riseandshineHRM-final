...
export default function ScheduleImportWizardPage() {
  ...
  const commit = async () => {
    ...
    try {
      ...
      setStep(3)
      setTimeout(() => router.push(`/client-services/schedule?periodStart=${periodStart}&periodEnd=${periodEnd}`), 1200)
    } catch (e) {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 p-4">
      <div className="flex items-center justify-between gap-4">
        <div>
          <Link href="/client-services/schedule" className="text-sm text-[#0D9488] hover:underline">
            ← Schedule
          </Link>
