...
import { ensureEmployeeForMarketingProfile } from '@/lib/employees'
...
export async function POST(request: NextRequest) {
  try {
    ...
    // Create Employee wrapper row for this marketing profile
    await ensureEmployeeForMarketingProfile(profile.id)
