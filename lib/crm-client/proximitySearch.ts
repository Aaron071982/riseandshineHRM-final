...
export interface RunRbtProximitySearchOptions extends ProximityAddressInput {
  /** If set (e.g. from CrmClient), used instead of geocoding an address. */
...
/**
 * Shared Mapbox geocode + driving matrix flow used by scheduling-beta proximity and CRM Assign RBT.
 */
