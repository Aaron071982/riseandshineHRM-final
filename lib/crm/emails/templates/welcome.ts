...
export function renderWelcome(fields: StaffMergeFields): StaffEmailContent {
  ...
  return {
    ...
    bodyHtml: `
      ...
      ${para(`We&apos;ve included your <strong>Parent Welcome Packet</strong> as an email attachment. Please take a few minutes to read it when you have the chance — it explains, in plain language, exactly how ABA services work, who will be part of ${child}&apos;s team, and the step-by-step journey from today through your child&apos;s first session. There are no surprises hidden in it, and nothing you&apos;ll be expected to already know.`)}
