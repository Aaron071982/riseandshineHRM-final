...
export default function AddMarketingForm() {
  ...
  return (
    <Card className="dark:bg-[var(--bg-elevated)] dark:border-[var(--border-subtle)]">
      <CardHeader>
        <CardTitle>Marketing Team Member</CardTitle>
      </CardHeader>
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <Input id="campaigns" name="campaigns" placeholder="e.g. Social, Email" className="dark:bg-[var(--bg-input)] dark:border-[var(--border-subtle)]" />
          </div>
          <div className="space-y-2">
